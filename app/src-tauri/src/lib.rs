...
pub fn run() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            video_files::import_custom_video,
            ...
            cockroach_module::automation::read_cockroach_automation_rules,
            cockroach_module::automation::save_cockroach_automation_rules,
            extension_packs::execute_extension_pack_action,
