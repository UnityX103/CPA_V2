# Graph Report - CPA_V2  (2026-09-06)

## Corpus Check
- 377 files · ~479,184 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3484 nodes · 6980 edges · 207 communities (179 shown, 28 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 79 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `28a03240`
...
## Communities (207 total, 28 thin omitted)
...
Cohesion: 0.08
Nodes (41): presenceAutomationContextSignature(), applyLivePresenceSample(), applyPresenceCapability(), applyPresenceSample(), capabilityState(), createPresenceStore(), defaultMonitorRuntime, initialPresenceState() (+33 more)

### Community 3 - "pomodoroEndAction.ts"
Cohesion: 0.16
Nodes (11): basename(), MaybePromise, PomodoroEndActionResolution, PomodoroEndActionRuntime, PomodoroEndActionState, resolvePomodoroEndAction(), openPomodoroVideoWindow(), PomodoroVideoWindowAction (+3 more)
...
Cohesion: 0.07
Nodes (28): CameraDevice, listCameraDevices(), invoke, PresenceAvailability, SettingsTab, PresenceAuthorizationAction, presenceAuthorizationView, accountErrorText() (+20 more)
...
Cohesion: 0.05
Nodes (46): DevAlignApp(), initialMode(), initialTargetId(), MOCK_PLAYER, Mode, PaneProps, Target, TARGETS (+38 more)
...
Cohesion: 0.08
Nodes (38): applySnapshotToMirrors(), cloneActiveAppForMirror(), cloneDangerousChange(), cloneEntries(), clonePlayer(), clonePlayers(), hasIconDataProperty(), sameActiveAppIdentity() (+30 more)

### Community 24 - "bindingKey.ts"
Cohesion: 0.07
Nodes (43): ActiveAppState, useActiveAppStore, AccessibilityStatus, applyHealth(), BindingKeyActions, BindingKeyPlatform, BindingKeyState, BindingKeyStore (+35 more)

### Community 25 - "ExtensionSettingsOutlet.tsx"
Cohesion: 0.40
...
Cohesion: 0.08
Nodes (28): createPomodoroStore(), formatMmSs(), PomodoroPhase, freshStore(), createPomodoroBroadcast(), eventTypeFor(), POMODORO_BROADCAST_EVENT, POMODORO_BROADCAST_SNAPSHOT_REQUEST_EVENT (+20 more)
...
Cohesion: 0.16
Nodes (18): SoundSource, BREAK_END_SOUNDS, BuiltinPomodoroSound, builtinSoundForSelection(), DEFAULT_POMODORO_END_SOUNDS, defaultPlaybackDeps, FOCUS_END_SOUNDS, isObject() (+10 more)
...
Cohesion: 0.19
Nodes (17): COCKROACH_ACTIONS, COCKROACH_AUTOMATION_RESULT, COCKROACH_RULES_CHANGED, CockroachAction, CockroachRule, executeCockroachAction(), readCockroachRules(), saveCockroachRules() (+9 more)
...
### Community 121 - "pomodoro.ts"
Cohesion: 0.09
Nodes (35): ActiveAppInfo, { listenMock, invokeMock }, ConfirmedDispatchOptions, createDispatchRequestId(), dispatchConfirmed(), BRIDGE_VERSION, BridgeSnapshot, ConfirmedDispatchRequest (+27 more)
...
### Community 143 - "runtime.ts"
Cohesion: 0.17
Nodes (14): extensionPackCatalog, ExtensionPackId, ExtensionPackProgress, ExtensionRuntimeContribution, useExtensionPackStore, EventDrivenRuntimeAdapter, ActiveRuntimeEntry, ExtensionRuntimeModule (+6 more)
...
### Community 157 - "videoEditorModule.ts"
Cohesion: 0.47
...
### Community 159 - "SettingsPanel.test.tsx"
Cohesion: 0.33
Nodes (4): invoke, listen, message, open

### Community 160 - "host.ts"
Cohesion: 0.15
Nodes (24): activeAppIdentitySig(), activeAppSig(), applyDispatch(), appUpdateSig(), appUpdateSnapshot(), bindingKeySig(), buildSnapshot(), BuildSnapshotOptions (+16 more)
...
### Community 177 - "audioPlayback.ts"
Cohesion: 0.28
Nodes (7): AudioOutputDevice, AudioPlaybackResult, listAudioOutputDevices(), playSound(), invoke, playAudioSource(), AudioSettingsCard()
...
Cohesion: 0.25
Nodes (11): FocusableAppWindowLabel, focusAppWindow(), { invokeMock }, playPomodoroEndSound(), customVideoSrc(), pickCustomWebmPath(), showCustomVideoMissingMessage(), mocks (+3 more)
...
### Community 201 - "pomodoroVideos.ts"
Cohesion: 0.39
