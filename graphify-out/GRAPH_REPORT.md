...
Cohesion: 0.09
Nodes (29): useBridgeClient(), saveRemotePlayerCardPosition(), INPUT_COUNTER_BASE_HEIGHT, INPUT_COUNTER_BASE_WIDTH, MAIN_WINDOW_BASE_SIZE, ScaledWindowSizeOptions, SETTINGS_WINDOW_BASE_SIZE, SETTINGS_WINDOW_MIN_SIZE (+21 more)

### Community 24 - "ui/SettingsPanel.tsx"
Cohesion: 0.06
Nodes (34): AudioOutputDevice, AudioPlaybackResult, listAudioOutputDevices(), invoke, CameraDevice, listCameraDevices(), invoke, settingsContributionsFor() (+26 more)
...
Cohesion: 0.06
Nodes (71): App(), buildStartupSettingsSnapshot(), clampStartupScale(), getStartupSettingsState(), StartupArchiveSource, mocks, userPreferenceStores(), waitForAccountRestoreAttempt() (+63 more)
...
Cohesion: 0.11
Nodes (28): createPomodoroStore(), DEFAULT_END_ACTION_VIDEO, PomodoroEndActionSourceKind, PomodoroPhase, PomodoroPinSource, PomodoroStore, PresenceAutomationState, freshStore() (+20 more)
...
Cohesion: 0.06
Nodes (60): ActiveAppInfo, AppUpdateSnapshot, BindingKeyEntry, { listenMock, invokeMock }, applySnapshotToMirrors(), cloneActiveAppForMirror(), cloneDangerousChange(), cloneEntries() (+52 more)
...
### Community 160 - "pomodoroVideoWindow.ts"
Cohesion: 0.29
