...
## Corpus Check
- 393 files · ~484,621 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3577 nodes · 7216 edges · 215 communities (185 shown, 30 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 79 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9957c913`
...
- PomodoroEndActionLayer.test.tsx
...
Cohesion: 0.06
Nodes (52): defaultRuntime, INPUT_ACTIVITY_POLL_MS, InputActivityRuntime, startInputActivityMonitor(), fixture(), monitor(), PomodoroStore, presenceAutomationContextSignature() (+44 more)

### Community 3 - "ui/PomodoroPanel.tsx"
Cohesion: 0.06
Nodes (25): DevAlignApp(), initialMode(), initialTargetId(), MOCK_PLAYER, Mode, PaneProps, Target, TARGETS (+17 more)
...
### Community 12 - "app_update.rs"
Cohesion: 0.17
Nodes (22): A, check_app_update(), check_source(), cnb_package_success_skips_github_download(), download_from(), DownloadEvent, downloads_use_exact_selected_version_in_both_directions(), github_success_never_queries_cnb_even_when_up_to_date() (+14 more)

### Community 13 - "settings.ts"
Cohesion: 0.12
Nodes (25): applyAutostartEnabled(), readAutostartEnabled(), plugin, BreakPetMode, clampScale(), clampSoundVolume(), createDangerousChangeId(), createSettingsStore() (+17 more)
...
Cohesion: 0.08
Nodes (31): clearPersistedAccountSession(), isPersistedAccountSessionV1(), loadPersistedAccountSession(), openStore(), PersistedAccountSession, PersistedAccountSessionV1, savePersistedAccountSession(), store (+23 more)

### Community 17 - "appUpdate.ts"
Cohesion: 0.15
Nodes (12): APP_UPDATE_CHECK_INTERVAL_MS, APP_UPDATE_REQUEST_TIMEOUT_MS, APP_UPDATE_STARTUP_DELAY_MS, AppUpdateActions, AppUpdateDeps, AppUpdateStatus, AppUpdateStore, createAppUpdateStore() (+4 more)
...
### Community 22 - "windows_process_tests.rs"
Cohesion: 0.18
...
Cohesion: 0.09
Nodes (30): useActiveAppStore, useBridgeClient(), saveRemotePlayerCardPosition(), INPUT_COUNTER_BASE_HEIGHT, INPUT_COUNTER_BASE_WIDTH, MAIN_WINDOW_BASE_SIZE, ScaledWindowSizeOptions, SETTINGS_WINDOW_BASE_SIZE (+22 more)

### Community 24 - "ui/SettingsPanel.tsx"
Cohesion: 0.04
Nodes (66): AudioOutputDevice, AudioPlaybackResult, listAudioOutputDevices(), invoke, AccessibilityStatus, applyHealth(), BindingInput, BindingKeyActions (+58 more)

### Community 25 - "appUpdatePersistence.ts"
Cohesion: 0.25
...
Cohesion: 0.11
Nodes (32): App(), buildStartupSettingsSnapshot(), clampStartupScale(), getStartupSettingsState(), StartupArchiveSource, mocks, userPreferenceStores(), waitForAccountRestoreAttempt() (+24 more)

### Community 27 - "extension_packs.rs"
Cohesion: 0.19
Nodes (37): dependent_id(), emit_statuses(), execute_extension_pack_action(), extension_pack_statuses(), ExtensionEventRules, ExtensionPackPreferences, ExtensionPackStatus, ExtensionPackStatusChanged (+29 more)
...
### Community 35 - "userPreferences.ts"
Cohesion: 0.09
Nodes (47): AppUpdateSnapshot, AppUpdateStore, BindingKeyStore, cloneBindingKey(), cloneBindingKeyEntry(), CloudStores, mergeCloudAccountDataConflict(), NetworkStore (+39 more)
...
### Community 46 - "mirror-github-release.mjs"
Cohesion: 0.11
Nodes (45): appRoot, config, output, download(), githubJson(), exec, importTag(), latestRelease() (+37 more)
...
Cohesion: 0.23
Nodes (19): allow_video_asset_file(), CustomVideoValidation, failed_import_preserves_previous_copy_and_removes_partial_files(), import_custom_video(), import_owned_webm(), imported_video_survives_source_deletion_and_replacement_keeps_only_one_copy(), invalid(), prepare_custom_alpha_video_path() (+11 more)

### Community 49 - "video_files/macos.rs"
Cohesion: 0.26
Nodes (18): alpha_cache_filename(), alpha_tmp_path(), alpha_transcode_supports_vp9_and_vp8_sources(), cached_alpha_video_is_fresh(), clear_cached_paths(), clear_playable_cache(), ffmpeg_alpha_transcode_arguments(), prepare_playable_path() (+10 more)
...
Cohesion: 0.11
Nodes (23): createExtensionPackStore(), emptyRevisions(), emptyStatus(), emptyStatuses(), errorText(), ExtensionPackDescriptor, ExtensionPackKind, ExtensionPackRevisions (+15 more)
...
### Community 70 - "CPA_V2"
Cohesion: 0.06
Nodes (26): Third-party sources, Cockroach Electron module, Event/action rules, Package layered components, Prepare the reviewed source, Upstream settings and lifecycle, Cockroach event/action rules, Feature actions (+18 more)
...
Cohesion: 0.22
Nodes (14): COCKROACH_ACTIONS, COCKROACH_AUTOMATION_RESULT, COCKROACH_RULES_CHANGED, CockroachAction, CockroachRule, executeCockroachAction(), readCockroachRules(), saveCockroachRules() (+6 more)
...
Cohesion: 0.43
Nodes (7): clear_playable_cache(), prepare_playable_path(), AppHandle, Path, PathBuf, Result, String
...
Cohesion: 0.07
Nodes (55): ActiveAppInfo, ActiveAppState, BindingKeyEntry, { listenMock, invokeMock }, applySnapshotToMirrors(), cloneActiveAppForMirror(), cloneDangerousChange(), cloneEntries() (+47 more)

### Community 122 - "runtime.ts"
Cohesion: 0.16
Nodes (15): extensionPackCatalog, ExtensionPackId, ExtensionPackProgress, extensionPackRegistry, ExtensionRuntimeContribution, useExtensionPackStore, EventDrivenRuntimeAdapter, ActiveRuntimeEntry (+7 more)
...
### Community 143 - "pomodoroSounds.ts"
Cohesion: 0.15
...
### Community 146 - "build_runtime.py"
Cohesion: 0.08
Nodes (48): clean_source_commit(), digest(), download(), interpreter_target(), main(), prepare_frozen_runtime(), prepare_models(), Path (+40 more)
...
### Community 157 - "pomodoroVideos.ts"
Cohesion: 0.39
...
Cohesion: 0.09
Nodes (32): ensure_entry_executable(), restore_archive_permissions(), restore_archive_symlink(), Command, Option, Path, Result, String (+24 more)

### Community 159 - "GitHub 云端发布与 CNB 下载镜像"
Cohesion: 0.29
Nodes (6): GitHub 云端发布与 CNB 下载镜像, 凭据边界, 故障与成本, 日常操作, 本地验证, 签名、索引与镜像

### Community 160 - "TextInput.tsx"
Cohesion: 0.47
...
Cohesion: 0.06
Nodes (27): Canonical code seams, CPA V2 extension contract, Disable, Install or upgrade, Lifecycle commands, Ownership model, Runtime contribution manifest, Security and release boundaries (+19 more)
...
### Community 177 - "VideoPlayerApp.tsx"
Cohesion: 0.60
...
Cohesion: 0.25
Nodes (11): FocusableAppWindowLabel, focusAppWindow(), { invokeMock }, openPomodoroVideoWindow(), customVideoSrc(), pickCustomWebmPath(), showCustomVideoMissingMessage(), mocks (+3 more)

### Community 198 - "pomodoro.ts"
Cohesion: 0.10
Nodes (30): createDispatchRequestId(), dispatchConfirmed(), createPomodoroStore(), DEFAULT_END_ACTION_VIDEO, PomodoroEndActionSourceKind, PomodoroPhase, PomodoroPinSource, PresenceAutomationState (+22 more)
...
### Community 202 - "pomodoroEndAction.ts"
Cohesion: 0.17
Nodes (10): basename(), MaybePromise, PomodoroEndActionResolution, PomodoroEndActionRuntime, PomodoroEndActionState, resolvePomodoroEndAction(), PomodoroVideoWindowAction, mocks (+2 more)

### Community 203 - "PomodoroEndActionLayer.test.tsx"
Cohesion: 0.29
Nodes (5): PomodoroEndEvent, focusAppWindow, openPomodoroVideoWindow, playPomodoroEndSound, resolvePomodoroEndAction

### Community 204 - "ExtensionSettingsOutlet.tsx"
Cohesion: 0.40
Nodes (4): ExtensionSettingsRenderer, ExtensionSettingsOutlet(), SETTINGS_RENDERERS, PetSettingsTab()

### Community 205 - "休息期间键鼠活动辅助在场检测"
Cohesion: 0.40
Nodes (4): 休息期间键鼠活动辅助在场检测, 判定及生命周期, 原生接口, 验证

### Community 207 - "idle_milliseconds"
Cohesion: 0.50
Nodes (3): idle_milliseconds(), Result, String

### Community 208 - "sample_input_activity"
Cohesion: 0.50
Nodes (3): Result, String, sample_input_activity()

### Community 209 - "idle_milliseconds"
Cohesion: 0.50
Nodes (3): idle_milliseconds(), Result, String

### Community 211 - "latency.test.js"
Cohesion: 0.40
Nodes (3): authClient(), createTestServer(), sendJson()

### Community 212 - "soundFiles.ts"
Cohesion: 0.48
Nodes (5): customSoundSrc(), pickCustomMp3Path(), showCustomSoundMissingMessage(), mocks, validateCustomSoundPath()

### Community 214 - "videoEditorModule.ts"
Cohesion: 0.47
Nodes (4): launchVideoEditorModule(), readVideoEditorModuleStatus(), invoke, VideoEditorModuleStatus

## Knowledge Gaps
- **1029 isolated node(s):** `metadata`, `STATE_LABELS`, `ClockProps`, `PanelKey`, `MENU_ITEMS` (+1024 more)
...
- **Why does `ModuleChild` connect `ModuleChild` to `cockroach_module.rs`?**
...
- **Should `ui/PomodoroPanel.tsx` be split into smaller, more focused modules?**
