...
## Corpus Check
- 404 files · ~490,546 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3679 nodes · 7501 edges · 220 communities (186 shown, 34 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 81 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `88159c34`
...
Cohesion: 0.05
Nodes (72): defaultRuntime, INPUT_ACTIVITY_POLL_MS, InputActivityRuntime, startInputActivityMonitor(), fixture(), monitor(), createPomodoroStore(), PomodoroPhase (+64 more)

### Community 3 - "userPreferences.ts"
Cohesion: 0.08
Nodes (48): AppUpdateSnapshot, AppUpdateStore, BindingKeyStore, buildCloudAccountData(), cloneBindingKey(), cloneBindingKeyEntry(), cloudAccountDataKey(), CloudStores (+40 more)
...
Cohesion: 0.05
Nodes (49): DevAlignApp(), initialMode(), initialTargetId(), MOCK_PLAYER, Mode, PaneProps, Target, TARGETS (+41 more)
...
Cohesion: 0.09
Nodes (31): isVisibleBindingEntry(), useBridgeClient(), INPUT_COUNTER_BASE_HEIGHT, INPUT_COUNTER_BASE_WIDTH, MAIN_WINDOW_BASE_SIZE, ScaledWindowSizeOptions, SETTINGS_WINDOW_BASE_SIZE, SETTINGS_WINDOW_MIN_SIZE (+23 more)

### Community 24 - "ui/SettingsPanel.tsx"
Cohesion: 0.04
Nodes (63): AudioOutputDevice, AudioPlaybackResult, listAudioOutputDevices(), invoke, AccessibilityStatus, applyHealth(), BindingInput, BindingKeyActions (+55 more)

### Community 25 - "App.tsx"
Cohesion: 0.12
Nodes (27): App(), buildStartupSettingsSnapshot(), clampStartupScale(), getStartupSettingsState(), StartupArchiveSource, mocks, userPreferenceStores(), waitForAccountRestoreAttempt() (+19 more)

### Community 26 - "host.ts"
Cohesion: 0.16
...
### Community 121 - "ExtensionSettingsOutlet.tsx"
Cohesion: 0.40
...
Cohesion: 0.11
Nodes (12): formatMmSs(), { hover, view }, ClockRingProps, ClockState, clockStateOf(), phaseLabel(), PomodoroPanel(), { startDragging, invokeMock } (+4 more)

### Community 134 - "CockroachModulePanel.tsx"
Cohesion: 0.19
Nodes (13): CockroachModuleSettings, CockroachModuleStatus, killAllCockroaches(), launchCockroachModule(), readCockroachModuleStatus(), saveCockroachModuleSettings(), CockroachModulePanel(), DEFAULT_SETTINGS (+5 more)
...
### Community 157 - "pomodoro.ts"
Cohesion: 0.08
Nodes (45): ActiveAppInfo, BindingKeyEntry, { listenMock, invokeMock }, applySnapshotToMirrors(), cloneActiveAppForMirror(), cloneDangerousChange(), cloneEntries(), clonePlayer() (+37 more)
...
### Community 160 - "videoEditorModule.ts"
Cohesion: 0.47
...
### Community 198 - "pomodoroSounds.ts"
Cohesion: 0.15
...
### Community 211 - "pomodoroEndAction.ts"
Cohesion: 0.17
...
### Community 212 - "appUpdatePersistence.ts"
Cohesion: 0.25
...
### Community 213 - "pomodoroVideos.ts"
Cohesion: 0.39
...
- **Why does `snapshot()` connect `UserDataStore.js` to `pomodoro.ts`?**
