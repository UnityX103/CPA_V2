...
## Corpus Check
- 383 files · ~481,157 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3513 nodes · 7038 edges · 210 communities (182 shown, 28 thin omitted)
...
Cohesion: 0.07
Nodes (43): createDispatchRequestId(), dispatch(), dispatchConfirmed(), presenceAutomationContextSignature(), applyPresenceCapability(), capabilityState(), createPresenceStore(), defaultMonitorRuntime (+35 more)
...
Cohesion: 0.11
Nodes (26): useBridgeClient(), useExtensionPackSync(), saveRemotePlayerCardPosition(), INPUT_COUNTER_BASE_HEIGHT, INPUT_COUNTER_BASE_WIDTH, MAIN_WINDOW_BASE_SIZE, ScaledWindowSizeOptions, SETTINGS_WINDOW_BASE_SIZE (+18 more)

### Community 24 - "bindingKey.ts"
Cohesion: 0.06
Nodes (47): ActiveAppState, useActiveAppStore, AccessibilityStatus, applyHealth(), BindingInput, BindingKeyActions, BindingKeyPlatform, BindingKeyState (+39 more)

### Community 25 - "audioPlayback.ts"
Cohesion: 0.33
...
### Community 31 - "pomodoroVideoWindow.ts"
Cohesion: 0.29
...
Cohesion: 0.08
Nodes (48): AppUpdateSnapshot, AppUpdateStore, BindingKeyStore, cloneBindingKey(), cloneBindingKeyEntry(), CloudStores, mergeCloudAccountDataConflict(), NetworkStore (+40 more)
...
Cohesion: 0.11
Nodes (19): devDependencies, @testing-library/jest-dom, @testing-library/react, @types/node, @types/react, @types/react-dom, typescript, vite (+11 more)
...
Cohesion: 0.06
Nodes (44): createExtensionPackStore(), emptyRevisions(), emptyStatus(), emptyStatuses(), errorText(), extensionPackCatalog, ExtensionPackDescriptor, ExtensionPackId (+36 more)
...
### Community 85 - "pomodoroBroadcast.ts"
Cohesion: 0.10
Nodes (33): COCKROACH_ACTIONS, COCKROACH_AUTOMATION_RESULT, COCKROACH_RULES_CHANGED, CockroachAction, CockroachRule, executeCockroachAction(), readCockroachRules(), saveCockroachRules() (+25 more)
...
Cohesion: 0.11
Nodes (30): ActiveAppInfo, BindingKeyEntry, applySnapshotToMirrors(), cloneActiveAppForMirror(), cloneDangerousChange(), cloneEntries(), clonePlayer(), clonePlayers() (+22 more)

### Community 122 - "PresenceAvailability"
Cohesion: 0.47
...
### Community 177 - "ui/PlayerCard.tsx"
Cohesion: 0.11
Nodes (15): DevAlignApp(), initialMode(), initialTargetId(), MOCK_PLAYER, Mode, PaneProps, Target, TARGETS (+7 more)
...
### Community 204 - "inputActivity.ts"
Cohesion: 0.26
Nodes (12): defaultRuntime, INPUT_ACTIVITY_POLL_MS, InputActivityRuntime, startInputActivityMonitor(), fixture(), monitor(), PomodoroStore, applyCombinedPresence() (+4 more)
