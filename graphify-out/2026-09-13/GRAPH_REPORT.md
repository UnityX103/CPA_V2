...
## Corpus Check
- 403 files · ~490,508 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3677 nodes · 7500 edges · 212 communities (180 shown, 32 thin omitted)
...
Cohesion: 0.06
Nodes (53): defaultRuntime, INPUT_ACTIVITY_POLL_MS, InputActivityRuntime, startInputActivityMonitor(), fixture(), monitor(), PomodoroStore, presenceAutomationContextSignature() (+45 more)

### Community 3 - "App.tsx"
Cohesion: 0.06
Nodes (69): App(), buildStartupSettingsSnapshot(), clampStartupScale(), getStartupSettingsState(), StartupArchiveSource, mocks, userPreferenceStores(), waitForAccountRestoreAttempt() (+61 more)
...
Cohesion: 0.13
Nodes (23): useBridgeClient(), saveRemotePlayerCardPosition(), INPUT_COUNTER_BASE_HEIGHT, INPUT_COUNTER_BASE_WIDTH, MAIN_WINDOW_BASE_SIZE, ScaledWindowSizeOptions, SETTINGS_WINDOW_BASE_SIZE, SETTINGS_WINDOW_MIN_SIZE (+15 more)

### Community 24 - "ui/SettingsPanel.tsx"
Cohesion: 0.04
Nodes (67): AudioOutputDevice, AudioPlaybackResult, listAudioOutputDevices(), playSound(), SoundSource, invoke, CameraDevice, listCameraDevices() (+59 more)
...
### Community 122 - "pomodoroBroadcast.ts"
Cohesion: 0.07
Nodes (33): formatMmSs(), PomodoroPhase, createPomodoroBroadcast(), eventTypeFor(), POMODORO_BROADCAST_EVENT, POMODORO_BROADCAST_SNAPSHOT_REQUEST_EVENT, POMODORO_BROADCAST_VERSION, PomodoroBroadcast (+25 more)
...
Cohesion: 0.06
Nodes (69): ActiveAppInfo, { listenMock, invokeMock }, applySnapshotToMirrors(), cloneActiveAppForMirror(), cloneDangerousChange(), cloneEntries(), clonePlayer(), clonePlayers() (+61 more)
