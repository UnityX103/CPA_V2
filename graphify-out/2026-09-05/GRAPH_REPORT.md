...
## Corpus Check
- 376 files · ~478,151 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3456 nodes · 6914 edges · 208 communities (180 shown, 28 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 78 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ce68d3d0`
...
- 临时聚焦窗口设计
- 专注结束后自动置顶设计
- ExtensionPackManagerTab.test.tsx
...
Cohesion: 0.07
Nodes (44): createDispatchRequestId(), dispatchConfirmed(), presenceAutomationContextSignature(), applyLivePresenceSample(), applyPresenceCapability(), applyPresenceSample(), capabilityState(), createPresenceStore() (+36 more)
...
Cohesion: 0.06
Nodes (34): BindingInput, MouseButton, CameraDevice, listCameraDevices(), invoke, PresenceAvailability, PersistedBindingKeyEntry, InputBindingBadge() (+26 more)
...
Cohesion: 0.05
Nodes (44): clearPersistedAccountSession(), isPersistedAccountSessionV1(), loadPersistedAccountSession(), openStore(), PersistedAccountSession, PersistedAccountSessionV1, savePersistedAccountSession(), store (+36 more)
...
Cohesion: 0.09
Nodes (32): AccessibilityStatus, applyHealth(), BindingKeyActions, BindingKeyPlatform, BindingKeyState, BindingKeyStore, createBindingKeyStore(), hasVisibleInputCounterEntries() (+24 more)

### Community 23 - "useSettingsStore"
Cohesion: 0.10
Nodes (28): useActiveAppStore, useBridgeClient(), useExtensionPackSync(), INPUT_COUNTER_BASE_HEIGHT, INPUT_COUNTER_BASE_WIDTH, MAIN_WINDOW_BASE_SIZE, ScaledWindowSizeOptions, SETTINGS_WINDOW_BASE_SIZE (+20 more)
...
Cohesion: 0.15
Nodes (17): createPomodoroStore(), PomodoroStore, freshStore(), createPomodoroBroadcast(), eventTypeFor(), POMODORO_BROADCAST_EVENT, POMODORO_BROADCAST_SNAPSHOT_REQUEST_EVENT, POMODORO_BROADCAST_VERSION (+9 more)
...
Cohesion: 0.07
Nodes (61): AppUpdateSnapshot, BindingKeyEntry, AppUpdateStore, BindingKeyStore, buildCloudAccountData(), cloneBindingKey(), cloneBindingKeyEntry(), cloudAccountDataKey() (+53 more)
...
Cohesion: 0.09
Nodes (26): createExtensionPackStore(), emptyRevisions(), emptyStatus(), emptyStatuses(), errorText(), ExtensionPackDescriptor, ExtensionPackKind, extensionPackRegistry (+18 more)
...
### Community 121 - "protocol.ts"
Cohesion: 0.10
Nodes (31): ActiveAppInfo, ActiveAppState, { listenMock, invokeMock }, applySnapshotToMirrors(), cloneActiveAppForMirror(), cloneDangerousChange(), cloneEntries(), clonePlayer() (+23 more)
...
### Community 143 - "ExtensionPackManagerTab.test.tsx"
Cohesion: 0.24
Nodes (8): extensionPackCatalog, ExtensionPackProgress, useExtensionPackStore, COMMON_PACKS, ExtensionPackManagerTab(), FEATURE_PACKS, invoke, listeners
...
### Community 157 - "eventDrivenRuntime.ts"
Cohesion: 0.28
...
### Community 199 - "execute_action"
Cohesion: 0.31
Nodes (16): CockroachAction, CockroachRule, execute_action(), read_cockroach_automation_rules(), read_rules(), AppHandle, Path, PathBuf (+8 more)
...
### Community 204 - "VideoPlayerApp.tsx"
Cohesion: 0.60
...
- **Why does `snapshot()` connect `UserDataStore.js` to `protocol.ts`?**
